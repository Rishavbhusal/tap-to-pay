/**
 * Program IDL type in camelCase format for use in JS/TS.
 * Generated from the anchor IDL at idl/nfc_smart_vault.json
 */
export type NfcSmartVault = {
  address: "BpvLHSZELbZk8jLHohBojnTVkEJqftA5EjeuTvXik1rJ";
  metadata: {
    name: "nfcSmartVault";
    version: "0.1.0";
    spec: "0.1.0";
  ...
  errors: [
    ...
    { code: 6003; name: "signatureVerificationFailed"; msg: "Signature verification failed" },
    { code: 6004; name: "dailyLimitExceeded"; msg: "Daily limit exceeded" },
